    ...
    <div className="container mx-auto px-5">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="bg-light-grey rounded-md h-full p-6 flex flex-col gap-3">
          ...
          <p>
            This policy explains Churchill Institute of Higher Education's (CIHE
            or 'the Institute') commitment to providing the support services
            students need to successfully complete their studies at the
            Institute.
          </p>
          <Link
