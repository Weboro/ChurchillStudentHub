...
const FilterComponent = ({ searchQuery, onSearchQuery }) => {
  const filterOptions = {
  ...
  return (
    <div className="p-4 rounded-xl bg-custom-pink lg:w-[25rem] h-fit">
      <h1
        className="font-extrabold text-xl lg:text-2xl pb-2
      relative before:absolute before:bottom-0 before:left-0 hover:before:w-full before:w-1/4 before:h-1 before:bg-custom-orange before:transition-all
      "
      >
        Filter Dates
      </h1>
